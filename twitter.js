 ...
 */
 ...
 class esportTeam {
     constructor(name,shorthand,handle){
         this.name = name;
         this.handle = handle;
...
const cloud9 = new esportTeam('cloud9','c9','cloud9');
console.log(cloud9.name + cloud9.shorthand + cloud9.handle);


var configProfile = {
  "profile": {"screenName": 'nebtunefgc'},
  "domId": 'example1',
  "maxTweets": 10,
  "enableLinks": true, 
  "showUser": true,
...
var configList = {
  "list": {"listSlug": 'inspiration', "screenName": 'nebtunefgc'},
  "domId": 'example3',
  "maxTweets": 3,
  "enableLinks": true, 
  "showUser": true,
